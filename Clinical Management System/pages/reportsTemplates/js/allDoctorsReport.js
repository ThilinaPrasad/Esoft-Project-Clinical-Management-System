    $.get("php/getAllDcotorsDataReport.php", function (data, status) {
        let temp_html = '';
        if (data.length != 0 && data != 'false') {
            ...
            for(let i=0;i<data.length;i++){
                ...
                temp_html += '<tr>\n' +
                    ...
                    '<td style="text-align:left;">'+data[i].medLicenceNo+'</td>\n' +
                    '<td style="text-align:left;">'+data[i].speciality+'</td>\n' +
    ...
    function getPDFFileButton () {
        ...
        return html2canvas($('#content'), {
            ...
            onrendered: function(canvas) {
                ...
                pdf.save('Kenway Medicals(All doctor user data).pdf');
            }
        });
    }
